...
public class MicrometerTimedService {
	 ...
	 */
	@Timed(value = "fs.sms.timed", description = "method sendByAli", extraTags = { "provider", "ali" },
	...
	public void countByResult(String result) {
		...
		// or
		Counter.builder("fs.sms.timed").description("send sms").tags("result", result).register(registry).increment();
	}
