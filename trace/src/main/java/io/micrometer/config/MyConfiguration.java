        ...
        return args -> {
            ...
            Observation.createNotStarted("my.observation", registry)
                    ...
                    .observe(() -> {
                        ...
                        String response = restTemplate.getForObject("http://localhost:8989/user/{userId}", String.class, highCardinalityUserId); // Boot's RestTemplate instrumentation creates a child span here
