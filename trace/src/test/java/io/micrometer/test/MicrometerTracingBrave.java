...
public class MicrometerTracingBrave {
    ...
    public static void main(String[] args) {
        ...
        AsyncReporter<zipkin2.Span> reporter = AsyncReporter.create(OkHttpSender.create("http://10.188.188.170:9411/api/v2/spans"));
        ...
        Tracing tracing = Tracing.newBuilder().currentTraceContext(braveCurrentTraceContext).supportsJoin(false)
                // 对Span内容进行序列化和反序列化
                .traceId128Bit(true).propagationFactory(BaggagePropagation.newFactoryBuilder(B3Propagation.FACTORY)
